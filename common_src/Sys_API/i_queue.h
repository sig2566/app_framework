...
#ifndef _I_QUEUE_GLOBAL_H
#define _I_QUEUE_GLOBAL_H
...
typedef struct _Queue
{
	...
	uint16_t  NumOfElements;		//Number of elements in the queue
	uint16_t  pad;
} QUEUE_t, *PQUEUE_t;
...
static inline void_t QUEUE_init(QUEUE_t * pQueue);
static inline void_t SQUEUE_init(SQUEUE_t * pQueue);
static inline NODE_t *QUEUE_dequeue(QUEUE_t * pQueue);
static inline SNODE_t *SQUEUE_dequeue(SQUEUE_t * pQueue);
static inline void_t QUEUE_release_element(QUEUE_t * pQueue, NODE_t * pData);
static inline void_t SQUEUE_release_element(SQUEUE_t * pQueue, SNODE_t * pData);
static inline void_t QUEUE_enqueue(QUEUE_t * pQueue, NODE_t * pData);
static inline void_t SQUEUE_enqueue(SQUEUE_t * pQueue, SNODE_t * pData);
static inline void_t QUEUE_attach(QUEUE_t * pQueue, NODE_t * pNode, NODE_t * pData);
static inline void_t SQUEUE_attach(SQUEUE_t * pQueue, SNODE_t * pNode, SNODE_t * pData);
static inline void_t QUEUE_enqueue_before(QUEUE_t * pQueue, NODE_t * pNode, NODE_t * pData);
...
static inline NODE_t *QUEUE_detach(QUEUE_t * pQueue, uint16_t NumOfElements);
static inline SNODE_t *SQUEUE_detach(SQUEUE_t * pQueue, uint16_t NumOfElements);
static inline bool_t QUEUE_isHead(QUEUE_t * pQueue, NODE_t * pData);
 ...
 * Returns:     NONE
 */
static inline void_t QUEUE_init
(
...
// See QUEUE_init
static inline void_t SQUEUE_init
(
 ...
 * Returns:     NONE
 */
static inline void_t QUEUE_release_element
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure       */
...
static inline void_t SQUEUE_release_element
(
	SQUEUE_t		*pQueue,	/* The pointer to the queue structure       */
 ...
 * Returns:     NONE
 */
static inline void_t QUEUE_enqueue
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure       */
...
// See QUEUE_enqueue
static inline void_t SQUEUE_enqueue
(
	SQUEUE_t		*pQueue,	/* The pointer to the queue structure       */
 ...
 * Returns:     NONE
 */
static inline void_t QUEUE_attach
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure       */
 ...
 * Returns:     NONE
 */
static inline void_t SQUEUE_attach
(
	SQUEUE_t			*pQueue,	/* The pointer to the queue structure       */
 ...
 * Returns:     NONE
 */
static inline void_t QUEUE_enqueue_before
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure       */
    NODE_t			*pNode,		/* The pointer to the node                  */
    NODE_t			*pData		/* The pointer to the node to enqueue       */
...
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure   */
	uint16_t			 NumOfElements	/*Number of elements to detach*/
)
{
 ...
 * Returns:     bool_t
 */
static inline bool_t QUEUE_isHead
(
	QUEUE_t			*pQueue,	/* The pointer to the queue structure       */
    NODE_t			*pData		/* The pointer to the node to enqueue       */
)
...
#include "Platforms/V3/Cores/API/I_queue.h"
#elif (PLATFORMNAME == V4_CDP)
#include "Platforms/V4/Cores/API/I_queue.h"
#else
